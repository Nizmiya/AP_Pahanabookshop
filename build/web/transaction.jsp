...
<%@page import="com.booking.TransactionServlet"%>
...
<html>
    <head>
        ...
        <title>BookShop - Transaction Management</title>
        <!-- Bootstrap CSS -->
            ...
            if (request.getAttribute("transactions") == null) {
                try {
                    ...
                    if ("CUSTOMER".equals(role)) {
                        ...
                        transactions = transactionServlet.getTransactionsByCustomer(customerId);
                    } else {
                        // Admin, Manager, Cashier can see all transactions
                        transactions = transactionServlet.getAllTransactions();
                    }
